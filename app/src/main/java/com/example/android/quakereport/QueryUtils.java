...
public final class QueryUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        //Log.e("QueryUtils", "Fetch Earthquake Data");
        // Create URL object
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONArray earthquakesArray = earthquakesObject.getJSONArray("features");

            for (int i = 0; i < earthquakesArray.length(); i++  ) {
                JSONObject earthquakeObject = earthquakesArray.getJSONObject(i);
                JSONObject earthquakeProperties = earthquakeObject.getJSONObject("properties");
